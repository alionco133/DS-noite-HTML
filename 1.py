...
<head>
    ...
    <title>Meu Primeiro Front-End</title>
...
<body>
    ...
    <header class="cabecalho">
        ...
        <p>Uma página organizada para confirmar se HTML, CSS e JavaScript estão conectados corretamente.</p>
    </header>
    ...
    <main>
        ...
        <section class="painel" aria-labelledby="titulo-teste">
            ...
            <button id="testarProjeto" type="button">
                Verificar projeto
            </button>

            <p id="statusProjeto" class="status" aria-live="polite">
                Aguardando a verificação.
            </p>
        </section>
